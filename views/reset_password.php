                ...
                <div class="row">
                    <form method="post" action="" class="col-sm-12" id="form-reset">
                        ...
                        <div class="singin-btn-validate" style="margin-left: 100px;">
                            <button type="submit" name="reset_password"  class="btn font-weight-bold" role="button">Se connecter</button>
                        </div>
            ...
            <form method="post" action="" class="col-12" id="form-reset">
                ...
                <div class="col-10">
                    <div class="row mx-auto">
                        <button type="submit" name="reset_password" class="btn btn-primary w-100" role="button">Se connecter</button>
                    </div>
                </div>
                <br/>
            </form>
